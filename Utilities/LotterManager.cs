    ...
    public static class LMan
    {
        ...
        public static void ClearData(int clearType)
        {
            if (clearType == 1)
            {
                ...
                inventoryList.Clear();
                restrictPick = false;
                CastledsContent.instance.sub1 = 0;
                CastledsContent.instance.sub2 = 0;
                CastledsContent.instance.sub3 = 0;
                CastledsContent.instance.subT2 = false;
                CastledsContent.instance.subT3 = false;
                sound1Mul = 0;
                sound2Mul = 0;
                sound3Mul = 0;
                cancelEvent = false;
            ...
            if (clearType == 2)
            {
                ...
                CastledsContent.instance.subT2 = false;
                CastledsContent.instance.subT3 = false;
                CastledsContent.instance.subT2a = false;
                sound1Mul = 0;
                sound2Mul = 0;
                sound3Mul = 0;
                cancelEvent = false;
            ...
            if (clearType == 3)
            {
                ...
                CastledsContent.instance.title2Alpha = 0;
                CastledsContent.instance.title3Alpha = 0;
                CastledsContent.instance.timer1 = 0;
                groupContra = 0;
                #endregion
                #region String Reset
                is1 = "";
