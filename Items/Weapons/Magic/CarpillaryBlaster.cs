...
namespace CastledsContent.Items.Weapons.Magic
{
    public class CarpillaryBlaster : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shootSpeed = 8f;
            item.shoot = ModContent.ProjectileType<Projectiles.Friendly.RedBloodCell>();
        }
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                int type2 = Main.rand.Next(5) == 0 ? ModContent.ProjectileType<Projectiles.Friendly.WhiteBloodCell>() : type;
